...
func MovRegImm(ins pcode.Instruction) ([]byte, []byte) {
	code := []byte{}
	data := []byte{}
...
func MovRegReg(ins pcode.Instruction) ([]byte, []byte) {
	code := []byte{}
	data := []byte{}
...
func MovRegInAddrFromReg(ins pcode.Instruction) ([]byte, []byte) {
	code, data := []byte{}, []byte{}
...
func MovRegFromRegInAddr(ins pcode.Instruction) ([]byte, []byte) {
	code, data := []byte{}, []byte{}
